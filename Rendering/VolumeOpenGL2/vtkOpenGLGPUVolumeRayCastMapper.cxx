...
//    }
  ...
  this->Impl->ShaderProgram->SetUniform3fv("in_volExtentsMin", 1, &fvalue3);

  vtkInternal::ToFloat(this->Impl->LoadedBounds[1],
                       this->Impl->LoadedBounds[3],
                       this->Impl->LoadedBounds[5], fvalue3);
  this->Impl->ShaderProgram->SetUniform3fv("in_volExtentsMax", 1, &fvalue3);
  ...
  this->Impl->ShaderProgram->SetUniform2fv("in_invOriginalWindowSize", 1, &fvalue2);

  vtkInternal::ToFloat(1.0 / this->Impl->WindowSize[0],
                       1.0 / this->Impl->WindowSize[1], fvalue2);
  this->Impl->ShaderProgram->SetUniform2fv("in_invWindowSize", 1, &fvalue2);
